  ...
  return (
    <div className='lg:flex lg:flex-row flex-col mt-[4rem] lg:mt-[0rem]'>
      ...
      <div className='w-[100%] lg:w-[20%] lg:p-[10px] bg-[#181818] fixed lg:block justify-evenly py-[10px] px-[5px] top-0'>
        ...
        <div className={`lg:h-[100vh] flex flex-col lg:justify-center lg:items-center justify-between h-[100%] hover:text-[#08fdd8] ${toggleOpen ? 'mt-[2rem] gap-y-[2rem] ml-4 md:items-center lg:gap-y-[0px] lg:mt-[0px]':'hidden lg:flex'}`}>
